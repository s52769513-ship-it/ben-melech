...
export default function CoordinatorDetailPage({
  ...
  return (
    <Suspense fallback={<CoordinatorDetailFallback />}>
      <CoordinatorDetailContent params={params} />
    </Suspense>
  );
}

function CoordinatorDetailFallback() {
  return (
    <div className="p-8">
      <div className="mb-6">
        <Link
...
async function CoordinatorDetailContent({
  params,
}: {
  params: Promise<{ id: string }>;
}) {
